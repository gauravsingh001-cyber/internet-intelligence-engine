        ...
        <div className="rounded-2xl bg-gradient-to-br from-cyan-500/10 via-blue-500/5 to-purple-500/10 border border-white/10 backdrop-blur-sm overflow-hidden">
          ...
          <div className="p-8 sm:p-12 lg:p-16">
            ...
            <p className="text-lg text-gray-300 mb-8">
              Get instant access to comprehensive company intelligence. No credit card required. Start analyzing companies in seconds.
            </p>
            ...
            <p className="text-sm text-gray-400 mt-8">
              Get started instantly with our fully functional intelligence platform.
            </p>
          </div>
        </div>
      </div>
